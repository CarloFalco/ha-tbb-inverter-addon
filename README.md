...
[![Add-on version](https://img.shields.io/badge/add--on-1.0.1-1f8fff?style=flat-square)](tbb_inverter/CHANGELOG.md)
...
ciclicamente, decodifica i frame e pubblica ogni grandezza su MQTT, rendendola
disponibile a Home Assistant per dashboard, automazioni e Energy Dashboard.
...
| 🔋 **Batteria** | Tensione, corrente con segno, SOC, temperatura, lettura BMS |
| 🔌 **Uscite AC** | Due uscite indipendenti (V / A / W) e frequenza di rete |
...
| 🎛️ **Scrittura** | Comando SmartPort (0-100 %) e invio di frame RS485 grezzi |
...
└── tbb_inverter/
    ...
    ├── tbb_reader.py          # polling RS485, decodifica frame, publish MQTT
    ├── requirements.txt
